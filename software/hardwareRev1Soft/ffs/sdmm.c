...
#include "../delay.h"		/* Common include file for FatFs and disk I/O layer */
...
#define SD_CS 		(1<<18)
#define	CS_H()		PTB->PSOR |= SD_CS	/* Set MMC CS "high" */
#define	CS_L()		PTB->PCOR |= SD_CS	/* Set MMC CS "high" */
...
)
{
	...
	do {
		...
		*buff++ = SPI0->DL;			/* Store a received byte */
	} while (--bc);
}
