...
#elif \
      !defined(MCU_MK65F18) /* TPM1, TPM2 */ && \
      !defined(MCU_MK65F18WS) /* TPM1, TPM2 */ && \
      !defined(MCU_MK66F18) /* TPM1, TPM2 */ && \
      !defined(MCU_MKL02Z4) /* TPM0, TPM1 */ && \
      !defined(MCU_MKL03Z4) /* TPM0, TPM1 */ && \
...
#if ((defined(MCU_MK65F18)) || (defined(MCU_MK65F18WS)) || (defined(MCU_MK66F18)) || (defined(MCU_MKL02Z4)) || (defined(MCU_MKL03Z4)))
 ...
 * @remarks The macro accesses the following registers: TPM1_SC, TPM2_SC,
 *          TPM0_SC (depending on the peripheral).
 * @par Example:
 *      @code
 ...
 *        (<component_name>_DEVICE).
 * @return Returns a 32-bit value.
 * @remarks The macro accesses the following registers: TPM1_CNT, TPM2_CNT,
 *          TPM0_CNT (depending on the peripheral).
 * @par Example:
 *      @code
 ...
 *        value.
 * @return Returns a value of void type.
 * @remarks The macro accesses the following registers: TPM1_MOD, TPM2_MOD,
 *          TPM0_MOD (depending on the peripheral).
 * @par Example:
 *      @code
 ...
 *        (<component_name>_DEVICE).
 * @return Returns a 32-bit value.
 * @remarks The macro accesses the following registers: TPM1_STATUS,
 *          TPM2_STATUS, TPM0_STATUS (depending on the peripheral).
 * @par Example:
 *      @code
 ...
 * @return Returns a value of void type.
 * @remarks The macro accesses the following registers: TPM1_CONF, TPM2_CONF,
 *          TPM0_CONF (depending on the peripheral).
 * @par Example:
 *      @code
