...
#define AX25MARKDELAY 310/* .5 */ 
#define AX25SPACEDELAY 170  /* .45  */ 
#define AX25BAUDTIME 20000

#define AX25SINDATALENGTH SINLENGTH64
#define ax25SinData sinData64
extern uint16_t ax25SinData[AX25SINDATALENGTH];
